...
- **Custom download filenames** — name your video file when rendering completes, with filename preview before download.
...
- Once confirmed, the project and all associated files are permanently removed.
...
- When rendering completes, you will be prompted to enter a custom filename for your video.
- The filename is pre-filled with your project name.
- The download button displays the filename (e.g., "Download: my_video.mp4") before you click it.
- You can see exactly what filename will be used before downloading.
